// ─── AUTO-GENERATED from IEM_Gymkhana_Committee_2026-27UPDATED.pdf ───────────
// Class Representative (CR) contact lists are intentionally excluded.
import type { Section } from "./membersData";

export const ADMINISTRATION: Section = {
  title: "Administration",
  accentColor: "#1e1e1e",
  members: [
    { slug: "prof-banani-chakrabarti", name: "Prof. Banani Chakrabarti", role: "Patron" },
    { slug: "prof-dr-satyajit-chakrabarti", name: "Prof. (Dr.) Satyajit Chakrabarti", role: "Patron" },
    { slug: "prof-dr-arun-kumar-bar", name: "Prof. (Dr.) Arun Kumar Bar", role: "Vice-Patron" },
    { slug: "prof-dr-biswajoy-chatterjee", name: "Prof. (Dr.) Biswajoy Chatterjee", role: "Vice-Patron" },
    { slug: "prof-dr-sanghamitra-poddar", name: "Prof. (Dr.) Sanghamitra Poddar", role: "President" },
  ],
};
...
export const FACULTY: Section = {
  ...
  accentColor: "#3B82F6",
  members: [
    { slug: "prof-dr-malay-gangopadhyay", name: "Prof. (Dr.) Malay Gangopadhyay" },
    { slug: "prof-dr-debika-bhattacharyya", name: "Prof. (Dr.) Debika Bhattacharyya" },
    { slug: "prof-dr-moutushi-biswas-singh", name: "Prof. (Dr.) Moutushi Biswas Singh" },
    { slug: "prof-gauri-majumder", name: "Prof. Gauri Majumder" },
    { slug: "prof-dr-prabir-kumar-das", name: "Prof. (Dr.) Prabir Kumar Das" },
    { slug: "prof-dr-koyel-ganguly", name: "Prof. (Dr.) Koyel Ganguly" },
    { slug: "prof-srijita-chakraborty", name: "Prof. Srijita Chakraborty" },
    { slug: "prof-soham-kanti-bishnu", name: "Prof. Soham Kanti Bishnu" },
    { slug: "prof-dr-amartya-mukherjee", name: "Prof. (Dr.) Amartya Mukherjee" },
    { slug: "prof-shreyasi-dutta", name: "Prof. Shreyasi Dutta" },
    { slug: "prof-dr-samapika-das-biswas", name: "Prof. (Dr.) Samapika Das Biswas" },
    { slug: "prof-dr-sukanya-mukherjee", name: "Prof. (Dr.) Sukanya Mukherjee" },
    { slug: "prof-bavrabi-ghosh", name: "Prof. Bavrabi Ghosh" },
    { slug: "prof-sanhita-ghosh", name: "Prof. Sanhita Ghosh" },
    { slug: "prof-ajanta-ghosh", name: "Prof. Ajanta Ghosh" },
    { slug: "prof-dr-rabin-mazumder", name: "Prof. (Dr.) Rabin Mazumder" },
    { slug: "prof-dr-shambhu-prasad-chakraborty", name: "Prof. (Dr.) Shambhu Prasad Chakraborty" },
    { slug: "prof-shrabana-chattopadhyay", name: "Prof. Shrabana Chattopadhyay" },
    { slug: "prof-dr-dwaipayan-de", name: "Prof. (Dr.) Dwaipayan De" },
    { slug: "prof-anupam-bhattacharya", name: "Prof. Anupam Bhattacharya" },
    { slug: "prof-nayantara-mitra", name: "Prof. Nayantara Mitra" },
    { slug: "prof-dr-gunjan-kumar", name: "Prof. (Dr.) Gunjan Kumar" },
    { slug: "prof-dr-rahul-baidya", name: "Prof. (Dr.) Rahul Baidya" },
    { slug: "prof-dr-sainik-kumar-mahata", name: "Prof. (Dr.) Sainik Kumar Mahata" },
    { slug: "prof-arindam-chakraborty", name: "Prof. Arindam Chakraborty" },
    { slug: "prof-avijit-bose", name: "Prof. Avijit Bose" },
    { slug: "prof-dr-ratna-chakraborty", name: "Prof. (Dr.) Ratna Chakraborty" },
    { slug: "prof-dr-subhabrata-banerjee", name: "Prof. (Dr.) Subhabrata Banerjee" },
    { slug: "prof-kaustav-bose", name: "Prof. Kaustav Bose" },
...
export const CORE_COMMITTEE: Section = {
  title: "Core Committee",
  accentColor: "#EF4444",
  members: [
    { slug: "debnath-mukherjee", name: "Debnath Mukherjee", role: "General Secretary", dept: "AI", phone: "7908448126" },
    { slug: "adrika-kundu", name: "Adrika Kundu", role: "Vice President", dept: "IT", phone: "8584999160" },
    { slug: "utkarsh-srivastava", name: "Utkarsh Srivastava", role: "Associate Vice President", dept: "ME", phone: "7980144505" },
  ],
};

export const CULTURAL_SECRETARY: Section = {
  title: "Cultural Secretary",
  accentColor: "#F97316",
  members: [
    { slug: "paramatha-ghosh", name: "Paramatha Ghosh", role: "Cultural Secretary", dept: "IOTCSBT", phone: "7797032617" },
    { slug: "debangkita-saha", name: "Debangkita Saha", role: "Cultural Secretary", dept: "IOT", phone: "8777495652" },
  ],
};

export const STUDENT_WELFARE: Section = {
  title: "Student Welfare Heads",
  accentColor: "#10B981",
  members: [
...
export const TECH_LEAD: Section = {
  title: "Institutional Technical Lead",
  accentColor: "#3B82F6",
  members: [
    { slug: "debangshu-chatterjee", name: "Debangshu Chatterjee", role: "Institutional Technical Lead", dept: "IOTCSBT", phone: "6290277345" },
    { slug: "souherdya-sarkar", name: "Souherdya Sarkar", role: "Institutional Technical Lead", dept: "IOTCSBT", phone: "8910169299" },
  ],
};

export const CULTURAL_REP: Section = {
  title: "Cultural Representative",
  accentColor: "#F97316",
  members: [
    { slug: "avinanda-dutta", name: "Avinanda Dutta", role: "Cultural Rep (BBA)", dept: "BBA", phone: "9332618419" },
    { slug: "esha-barman", name: "Esha Barman", role: "Cultural Rep (MBA)", dept: "MBA", phone: "7044425517" },
    { slug: "akash-chatterjee", name: "Akash Chatterjee", role: "Cultural Rep (MBA)", dept: "MBA", phone: "6290675182" },
    { slug: "tania-pan", name: "Tania Pan", role: "Cultural Rep (BHM)", dept: "BHM/BHTA3", phone: "9831856147" },
    { slug: "sohini-roy", name: "Sohini Roy", role: "Cultural Rep (BBA LLB)", dept: "BBA LLB", phone: "8334844147" },
    { slug: "isha-shaw", name: "Isha Shaw", role: "Cultural Rep (BCA)", dept: "BCA", phone: "9123365217" },
    { slug: "bhaskar-chakraborty", name: "Bhaskar Chakraborty", role: "Cultural Rep (MBA)", dept: "MBA", phone: "8413059792" },
  ],
};
...
export const GRAPHICS_CLUB: Section = {
  title: "Graphics Club (A.R.C.)",
  accentColor: "#EC4899",
  members: [
...
export const TECH_CLUB: Section = {
  title: "Tech Club",
  accentColor: "#06B6D4",
  members: [
...
export const GAMING_CLUB: Section = {
  title: "Gaming Club",
  accentColor: "#22D3EE",
  members: [
    { slug: "snigdharup-bagchi", name: "Snigdharup Bagchi", role: "Gaming (Head)", dept: "CSE", phone: "7601974410" },
    { slug: "mrityunjoy-chakraborty", name: "Mrityunjoy Chakraborty", role: "Gaming (Co-Head)", dept: "CSE AI", phone: "9832865464" },
    { slug: "nirmalya-kusum-ghosh", name: "Nirmalya Kusum Ghosh", role: "Gaming (Representative)", dept: "CSE", phone: "8597510306" },
    { slug: "anwesha-ghosh", name: "Anwesha Ghosh", role: "Gaming (Representative)", dept: "CSE", phone: "9007719690" },
  ],
};
...
export const SPORTS: Section = {
  ...
  accentColor: "#22C55E",
  members: [
    { slug: "ankush-das", name: "Ankush Das", role: "Sports (Head)", dept: "CSE", phone: "9051488256" },
    { slug: "adarsh-sahoo", name: "Adarsh Sahoo", role: "Sports (Co-Head)", dept: "ME", phone: "6295395031" },
    { slug: "arman-raza", name: "Arman Raza", role: "Sports (Athletics & Indoor Sports)", dept: "IOT", phone: "8235906112" },
  ],
};

export const SPORTS_REP: Section = {
  title: "Sports Representative",
  accentColor: "#22C55E",
  members: [
    { slug: "rishi-asthana", name: "Rishi Asthana", role: "Sports Representative (BBA)", dept: "BBA", phone: "8583996405" },
    { slug: "adarsh-giri", name: "Adarsh Giri", role: "Sports Representative (MBA)", dept: "MBA", phone: "9709943320" },
    { slug: "ayan-roy", name: "Ayan Roy", role: "Sports Representative (MBA)", dept: "MBA", phone: "8697224057" },
    { slug: "hrik-mukherjee", name: "Hrik Mukherjee", role: "Sports Representative (MBA)", dept: "MBA", phone: "9163527933" },
    { slug: "anisha-agarwal", name: "Anisha Agarwal", role: "Sports Representative (BBA LLB)", dept: "BBA LLB", phone: "9330312483" },
    { slug: "amit-dey", name: "Amit Dey", role: "Sports Representative (BHM)", dept: "BHM/BHTA3", phone: "6289077282" },
  ],
};

export const FOOTBALL: Section = {
  title: "Football",
  accentColor: "#22C55E",
  members: [
...
export const CRICKET: Section = {
  title: "Cricket",
  accentColor: "#22C55E",
  members: [
    { slug: "aayush-raj", name: "Aayush Raj", role: "Cricket (Captain)", dept: "IT", phone: "8002539802" },
...
export const KABADDI: Section = {
  title: "Kabaddi",
  accentColor: "#22C55E",
  members: [
    { slug: "amitanshu", name: "Amitanshu", role: "Kabaddi (Captain)", dept: "CSE", phone: "9060322995" },
    { slug: "pankaj-kumar", name: "Pankaj Kumar", role: "Kabaddi (Vice-Captain)", dept: "CSE IOT", phone: "9122798620" },
  ],
};

export const BADMINTON: Section = {
  title: "Badminton",
  accentColor: "#22C55E",
  members: [
    { slug: "prarthita-kuri", name: "Prarthita Kuri", role: "Badminton (Captain)", dept: "CSE", phone: "8910873650" },
  ],
};

export const BASKETBALL: Section = {
  title: "Basketball",
  accentColor: "#22C55E",
  members: [
...
export const GYMKHANA_ROOM: Section = {
  title: "Gymkhana Room Incharge",
  accentColor: "#78716C",
  members: [
    { slug: "ankush-das-1", name: "Ankush Das", role: "Room In-Charge", dept: "CSE", phone: "9051488256" },
  ],
};
...
export const CANTEEN_HEAD: Section = {
  ...
  accentColor: "#78716C",
  members: [
    { slug: "md-akram-molla", name: "Md. Akram Molla", role: "Canteen Head", dept: "IOTCSBT", phone: "9883857132" },
  ],
};
...
export const EASTERN_DANCE: Section = {
...
export const WESTERN_DANCE: Section = {
...
export const PHOTOGRAPHY_CLUB: Section = {
  ...
  accentColor: "#0EA5E9",
  members: [
    { slug: "deepan-pramanik", name: "Deepan Pramanik", role: "Photography Head", dept: "IT", phone: "8167846320" },
    { slug: "asmit-kundu", name: "Asmit Kundu", role: "Photography Co-Head", dept: "IT", phone: "7980631449" },
  ],
};
...
export const DEBATE_CLUB: Section = {
  ...
  accentColor: "#8B5CF6",
  members: [
    { slug: "sreyobrata-saha-1", name: "Sreyobrata Saha", role: "Convenor", dept: "BBA", phone: "7003847538" },
    { slug: "biplab-kumar-jha", name: "Biplab Kumar Jha", role: "Deputy Convenor", dept: "CSE AI", phone: "9382538192" },
  ],
};
...
export const QUIZ_CLUB: Section = {
  ...
  accentColor: "#8B5CF6",
  members: [
    { slug: "atrijo-banerjee", name: "Atrijo Banerjee", role: "Quiz Club (Head)", dept: "ECE", phone: "9007148837" },
    { slug: "ridhi-anand", name: "Ridhi Anand", role: "Quiz Club (Head)", dept: "CSBS", phone: "8016580047" },
    { slug: "sugandha-bose", name: "Sugandha Bose", role: "Quiz Club (Representative)", dept: "BCA", phone: "9330090269" },
  ],
};
...
export const ECELL: Section = {
  ...
  accentColor: "#3B82F6",
  members: [
    { slug: "sreyasi-mondol", name: "Sreyasi Mondol", role: "E-Cell (President)", dept: "IOTCSBT", phone: "9883177160" },
    { slug: "debangkita-saha-1", name: "Debangkita Saha", role: "E-Cell (VP)", dept: "IOT", phone: "8777494652" },
  ],
};
...
export const FILM_SOCIETY: Section = {
  ...
  accentColor: "#F59E0B",
  members: [
    { slug: "paramartha-ghosh", name: "Paramartha Ghosh", role: "Film Society (Head)", dept: "IOTCSBT", phone: "7797032617" },
    { slug: "adrika-kundu-1", name: "Adrika Kundu", role: "Film Society (Co-Head)", dept: "IT", phone: "8584999160" },
  ],
};
...
export const COLLEGE_MAGAZINE: Section = {
  ...
  members: [
    ...
    { slug: "rachishnu-paul-1", name: "Rachishnu Paul", role: "College Magazine", dept: "BCA", phone: "9830132572" },
  ],
};
...
export const HUMOUR_CLUB: Section = {
  ...
  accentColor: "#F59E0B",
  members: [
    { slug: "krish-j-kalwani", name: "Krish J Kalwani", role: "Humour Club (Head)", dept: "CSE", phone: "9836034788" },
  ],
};
...
export const STUDENT_CHAPTERS: Section = {
  ...
  accentColor: "#3B82F6",
  members: [
    { slug: "akashlina-bhowmick", name: "Akashlina Bhowmick", role: "ISHRAE", dept: "ME", phone: "8100495229" },
    { slug: "sharukh-khan", name: "Sharukh Khan", role: "ASHRAE", dept: "ME", phone: "7477750144" },
    { slug: "avinandan-mukherjee", name: "Avinandan Mukherjee", role: "SAE", dept: "ME", phone: "9836714226" },
    { slug: "tiyasha-mondal", name: "Tiyasha Mondal", role: "IEI (EE)", dept: "EE", phone: "9073399079" },
    { slug: "priti-koner", name: "Priti Koner", role: "IET", dept: "EE", phone: "6297333298" },
    { slug: "siddharth", name: "Siddharth", role: "IIW", dept: "ME", phone: "7033177666" },
    { slug: "subhadra-bhattacharyya", name: "Subhadra Bhattacharyya", role: "IEEE IEM EDS", dept: "ECE", phone: "9339747625" },
    { slug: "souhardya-ray", name: "Souhardya Ray", role: "IEEE IEM MTT-S", dept: "ECE", phone: "9831254802" },
    { slug: "soham-karak", name: "Soham Karak", role: "IEEE IEM APS", dept: "ECE", phone: "6297927520" },
    ...
    { slug: "abhinab-chatterjee", name: "Abhinab Chatterjee", role: "IEEE ComSoc SB", dept: "ECE", phone: "7699258932" },
    { slug: "rahi-chakraborty", name: "Rahi Chakraborty", role: "IETE ISF CSBS/CSE(AIML) IEM Student Chapter (Head)", dept: "CSBS", phone: "8910021771" },
    { slug: "arnab-namta", name: "Arnab Namta", role: "IEI-IEM (ME) Students' Chapter", dept: "ME", phone: "9153529042" },
    { slug: "tejas-bhattacharya", name: "Tejas Bhattacharya", role: "ASME-IEM Students' Chapter", dept: "ME", phone: "9433391527" },
    { slug: "siddhartha-ghosh", name: "Siddhartha Ghosh", role: "RAS Society", dept: "ECE", phone: "9903886309" },
  ],
};

export const allSections2026: Section[] = [
  ADMINISTRATION,
  FACULTY,
  CORE_COMMITTEE,
  CULTURAL_SECRETARY,
