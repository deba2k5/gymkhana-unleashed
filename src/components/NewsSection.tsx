    ...
    >
      <div className="relative max-w-[1400px] mx-auto px-6 lg:px-12 z-10">
        ...
        <div className="mb-20 lg:mb-32 flex flex-col lg:flex-row lg:items-end justify-between gap-10">
          ...
          <div className="flex items-center gap-4 px-8 py-4 rounded-full bg-primary text-primary-foreground text-xs font-black tracking-widest uppercase brutalist-shadow border-2 border-primary self-start lg:self-auto transition-colors">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-10 items-stretch">
          ...
          <motion.div
            ...
            className="group relative bg-black p-10 lg:p-16 overflow-hidden brutalist-shadow-lg cursor-pointer flex flex-col justify-between min-h-[500px] border-[3px] border-primary rounded-[2rem] transition-colors"
          >
            <div className="absolute inset-0 bg-[radial-gradient(ellipse_60%_60%_at_80%_20%,_hsl(var(--yellow-400)/0.1)_0%,_transparent_70%)]" />

            <div className="relative z-10">
              <div className="flex items-center gap-4 mb-6">
                <div className="px-4 py-1.5 rounded-full bg-yellow-400 text-black text-[10px] font-black tracking-[0.2em] uppercase brutalist-shadow-sm">
                  {featuredNews.tag}
                </div>
            ...
            <div className="relative z-10 flex items-center gap-5 mt-10 group/link">
              <div className="w-14 h-14 rounded-full border-2 border-white/25 flex items-center justify-center text-white group-hover/link:bg-yellow-400 group-hover/link:border-yellow-400 group-hover/link:text-black transition-all duration-400">
            ...
            <div className="overflow-x-auto hide-scrollbar" style={{ WebkitOverflowScrolling: "touch" }}>
              <div className="flex animate-marquee-slow whitespace-nowrap gap-6 min-w-max">
                {[...newsTrack1, ...newsTrack1, ...newsTrack1].map((n, i) => (
                  <div
                    key={i}
                    className="flex-shrink-0 w-[320px] border-[3px] border-primary rounded-2xl p-6 bg-card hover:bg-primary hover:text-primary-foreground transition-all duration-300 cursor-pointer group brutalist-shadow-sm"
                  >
                    <div className="flex justify-between items-center mb-4">
                      <span className="text-[9px] font-black tracking-[0.4em] uppercase border border-primary/20 rounded-full px-2 py-0.5 text-foreground/50 group-hover:text-primary-foreground/50 transition-colors">
                        {n.tag}
                      </span>
            ...
            <div className="overflow-x-auto hide-scrollbar" style={{ WebkitOverflowScrolling: "touch" }}>
              <div className="flex animate-marquee-slower whitespace-nowrap gap-6 min-w-max">
                {[...newsTrack2, ...newsTrack2, ...newsTrack2].map((n, i) => (
                  <div
                    key={i}
                    className="flex-shrink-0 w-[320px] border-[3px] border-primary rounded-2xl p-6 bg-card hover:bg-yellow-400 hover:text-black transition-all duration-300 cursor-pointer group brutalist-shadow-sm"
                  >
                    <div className="flex justify-between items-center mb-4">
                      <span className="text-[9px] font-black tracking-[0.4em] uppercase border border-primary/20 rounded-full px-2 py-0.5 text-foreground/50 group-hover:text-black/50 transition-colors">
                        {n.tag}
                      </span>
            ...
            <div className="overflow-x-auto hide-scrollbar" style={{ WebkitOverflowScrolling: "touch" }}>
              <div className="flex animate-marquee-slow whitespace-nowrap gap-6 min-w-max" style={{ animationDirection: "reverse" }}>
                {[...newsTrack3, ...newsTrack3, ...newsTrack3].map((n, i) => (
                  <div
                    key={i}
                    className="flex-shrink-0 w-[320px] border-[3px] border-primary rounded-2xl p-6 bg-yellow-400 text-black hover:bg-black hover:text-white transition-all duration-300 cursor-pointer group brutalist-shadow-sm"
                  >
                    <div className="flex justify-between items-center mb-4">
                      <span className="text-[9px] font-black tracking-[0.4em] uppercase border border-black/20 rounded-full px-2 py-0.5 group-hover:border-white/20 transition-colors">
                        {n.tag}
                      </span>
