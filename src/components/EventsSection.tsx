      ...
      <div className="relative max-w-[1400px] mx-auto px-6 lg:px-12 z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-6 lg:gap-8">
          ...
          <motion.div
            ...
            className="lg:col-span-12 group relative overflow-hidden brutalist-shadow-lg border-[3px] border-black"
          >
            {/* Background image */}
            <div
          ...
          {secondary.map((ev, idx) => (
            <motion.div
              ...
              className="lg:col-span-6 group relative overflow-hidden border-[3px] border-black bg-white"
            ...
            >
              ...
              <Link to={`/events/${ev.slug}`} className="relative z-10 p-10 flex flex-col min-h-[300px] cursor-pointer">
                <div className="flex justify-between items-start mb-auto">
                  <div className="w-14 h-14 bg-black flex flex-col items-center justify-center text-white border-2 border-black" style={{ boxShadow: "3px 3px 0 0 #facc15" }}>
                ...
                <div className="mt-8">
                  <h4
                    className="font-space font-black text-black tracking-tighter uppercase mb-4 group-hover:text-yellow-600 transition-colors"
                    style={{ fontSize: "clamp(1.75rem,3.5vw,2.5rem)", lineHeight: 0.9 }}
                  >
                    {ev.shortName}
                  </h4>
                  <p className="text-[11px] font-bold text-black/55 uppercase tracking-wide mb-6 leading-relaxed line-clamp-3">
                    {ev.desc}
                  </p>
            ...
            >
              ...
              <Link to={`/events/${ev.slug}`} className="relative z-10 p-10 flex items-center justify-between gap-8 min-h-[200px] cursor-pointer">
                <div className="flex-1">
                  ...
                  <p className="text-[11px] font-bold text-black/55 uppercase tracking-wide line-clamp-2">
                    {ev.desc}
                  </p>
                </div>
                <div className="shrink-0 flex flex-col items-end gap-4">
                  <span className="text-xl font-space font-black text-black italic">{ev.displayDate}</span>
